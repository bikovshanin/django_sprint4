# Generated by Django 3.2.16 on 2023-06-25 09:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slag', models.SlugField(max_length=64, unique=True, verbose_name='Идентификатор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=True, verbose_name='Опубликовано')),
                ('created_at', models.DateTimeField(verbose_name='Добавлено')),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to=settings.AUTH_USER_MODEL, verbose_name='Автор публикации')),
